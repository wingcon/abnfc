...
%%% Generated by abnfc_gen on 2012-12-28 11:02:54

-module(rfc3629_binary).
...
'UTF8-1'() ->
    fun (<<C, Tl/binary>>) when (C >= 0) and (C =< 127) ->
	    {ok, C, Tl};
	(_) -> fail
    end.
...
'UTF8-tail'() ->
    fun (<<C, Tl/binary>>) when (C >= 128) and (C =< 191) ->
	    {ok, C, Tl};
	(_) -> fail
    end.
		   ...
		   (oneof([?'SIZED'(V1,
			   ...
			   ?'SIZED'(V4,
				    (resize(if V4 > 0 -> V4 - 1;
					    ...
					    'UTF8-4_generator'())))])),
		   V5)),
	   (erlang:list_to_binary([V6]))).

'UTF8-1_generator'() ->
    ?'LET'(V2, (?'LET'(V1, (choose(0, 127)), V1)),
	   (erlang:list_to_binary([V2]))).
	   ...
	   (?'LET'(V15,
		   (oneof([?'LET'(V5,
			   ...
			   ?'LET'(V14,
				  ...
				  V14)])),
		   V15)),
	   (erlang:list_to_binary([V16]))).

'UTF8-tail_generator'() ->
    ?'LET'(V2, (?'LET'(V1, (choose(128, 191)), V1)),
	   (erlang:list_to_binary([V2]))).
