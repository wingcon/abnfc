...
-export(['ALPHA'/0, 'BIT'/0, 'CHAR'/0, 'CR'/0, 'CRLF'/0,
	 ...
	 'LF'/0, 'LWSP'/0, 'OCTET'/0, 'SP'/0, 'SQUOTE'/0,
	 'VCHAR'/0, 'WSP'/0, decode/2]).
...
-export(['ALPHA_generator'/1, 'BIT_generator'/1,
	 ...
	 'SQUOTE_generator'/1, 'VCHAR_generator'/1,
	 'WSP_generator'/1, generator/1]).
...
names() ->
    ['ALPHA', 'BIT', 'CHAR', 'CR', 'CRLF', 'CTL', 'DIGIT',
     'DQUOTE', 'SQUOTE', 'HEXDIG', 'HTAB', 'LF', 'LWSP',
     'OCTET', 'SP', 'VCHAR', 'WSP'].
...
generator('SQUOTE') -> 'SQUOTE_generator'(0);
...
'SQUOTE_generator'(Depth) when Depth >= 0 ->
    ?'LET'(V2, (?'LET'(V1, 39, V1)), V2).
